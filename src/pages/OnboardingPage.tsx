    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <span className="font-display text-2xl text-light tracking-tight">Beacon</span>
        </div>
        <div className="bg-surface rounded-2xl border border-border shadow-card p-8">
          <h1 className="font-display text-2xl text-light mb-1">Welcome to Beacon</h1>
          <p className="text-sm text-muted mb-6">Tell us a bit about yourself to get started.</p>
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-3">
              <Input id="firstName" label="First Name" placeholder="Alex" value={form.firstName} onChange={e => set('firstName', e.target.value)} />
              <Input id="lastName" label="Last Name" placeholder="Johnson" value={form.lastName} onChange={e => set('lastName', e.target.value)} />
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <Input id="gpa" label="GPA" placeholder="3.9" type="number" step="0.01" min="0" max="4.0" value={form.gpa} onChange={e => set('gpa', e.target.value)} />
              <Input id="sat" label="SAT" placeholder="1450" type="number" value={form.sat} onChange={e => set('sat', e.target.value)} />
              <Input id="act" label="ACT" placeholder="32" type="number" value={form.act} onChange={e => set('act', e.target.value)} />
            </div>
            <Combobox
              label="Home State"
              value={form.state}
